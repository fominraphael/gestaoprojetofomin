            ...
            <section className="flex-1 min-w-0 space-y-6">
              ...
              {loadingDocs ? (
                <div className="text-center py-16">
                  <span className="w-6 h-6 border-2 border-border border-t-slate-300 rounded-full animate-spin inline-block" />
                </div>
                        ...
                        <div className="mt-3 space-y-1.5">
                          {typeFiles.map((f) => (
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="flex items-center justify-between gap-2 text-xs text-foreground hover:text-blue-400 px-2 py-1.5 rounded-lg bg-background/50 hover:bg-background border border-border transition-all"
                            >
