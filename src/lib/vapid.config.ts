...
export const VAPID_PUBLIC_KEY = "BCvVGXw009sG-BULFOtLi5W0UO8pioNctr0w1thdp21Q38BK8S70Y5GvmuLde3d-jixlZXBhvpCVu7TJf8d5mbI";

// Server-side only: loaded from env var
export function getVapidPrivateKey(): string {
  return process.env.VAPID_PRIVATE_KEY || "Q4PoTxjH1UyhOjzKa1w3DSWliL9fmLDc-GiYswt4fN8";
}
